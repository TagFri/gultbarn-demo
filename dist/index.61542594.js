...
})({"24C1A":[function(require,module,exports,__globalThis) {
...
var _maskingJs = require("./masking.js");
var _inputHandlingJs = require("./inputHandling.js");
var _graphJs = require("./graph.js");
(0, _maskingJs.masking)();
(0, _inputHandlingJs.eventListeners)();
(0, _graphJs.initiateGraph)();

},{"./masking.js":"2xbeS","./graph.js":"6jWU4","./inputHandling.js":"8hbvI"}],"2xbeS":[function(require,module,exports,__globalThis) {
...
function masking() {
    ...
    Inputmask("99[9] \xb5mol/L").mask("bilirubin-value");
}
...
},{}],"6jWU4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initiateGraph", ()=>initiateGraph);
parcelHelpers.export(exports, "updateGraph", ()=>updateGraph);
var _inputHandlingJs = require("./inputHandling.js");
...
function updateGraph() {
    ...
    if (currentLightLimit === null || newLightLimit !== currentLightLimit) {
        ...
        myChart.update();
    } else console.log("no change in child graph");
//todo -> update lab-graph
}
function createLightLimit() {
    //Get gestaionWeek and BirthWeight
    let gestationWeek = (0, _inputHandlingJs.validatedChildInputs)["gestation-week"];
    let birthWeight = (0, _inputHandlingJs.validatedChildInputs)["birth-weight"];
    //Y-values for light-limits
    let lightValues = // Birthweight < 1000:
    birthWeight < 1000 ? [
        "Under 1000g",
        "Nan",
        100,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./inputHandling.js":"8hbvI","chart.js/auto":"d8NN9"}],"8hbvI":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "eventListeners", ()=>eventListeners);
parcelHelpers.export(exports, "validatedLabInputs", ()=>validatedLabInputs);
parcelHelpers.export(exports, "validatedChildInputs", ()=>validatedChildInputs);
var _graphJs = require("./graph.js");
...
function inputToIntegers(unformattedValue) {
    ...
    if (/[gud]/.test(unformattedValue)) formattedValue = parseInt(unformattedValue.substring(0, unformattedValue.length - 1));
    else if (/µmol\/L/.test(unformattedValue)) formattedValue = parseInt(unformattedValue.substring(0, unformattedValue.length - 6));
...
function validation(id, integer) {
    ...
    if (id.includes("time") || id.includes("date")) integer != null && integer[0] >= validationCriteria[sorting][0][0] && integer[0] <= validationCriteria[sorting][0][1] && integer[1] >= validationCriteria[sorting][1][0] && integer[1] <= validationCriteria[sorting][1][1] ? validInputClass(id, integer) : invalidInputClass(id);
    else integer != null && integer >= validationCriteria[id][0] && integer <= validationCriteria[id][1] ? validInputClass(id, integer) : invalidInputClass(id);
...
function validateChild() {
    if (Object.keys(validatedChildInputs).length === 5 || Object.keys(validatedLabInputs).includes("birth-date")) (0, _graphJs.updateGraph)();
} //TODO IMPLEMENT LABS

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./graph.js":"6jWU4"}],"d8NN9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["24C1A","ahc7M"], "ahc7M", "parcelRequire94c2")
