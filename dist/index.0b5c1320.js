    ...
    return function() {
        ...
        var e = {
            ...
            6030: function(e, t, n) {
                ...
                var m, g, y = t.EventHandlers = {
                    keyEvent: function(e, t, n, i, a) {
                        ...
                        return o.isComposing = g == s.keys.Process || g == s.keys.Unidentified, o.ignorable = void 0 === g || g.length > 1 && !("textarea" === v.tagName.toLowerCase() && g == s.keys.Enter), y.keypressEvent.call(this, e, t, n, i, a);
                    },
                    ...
                    setValueEvent: function(e) {
                        ...
                        void 0 === a && (a = i.inputmask._valueGet(!0)), (0, l.applyInputValue)(i, a, new n.Event("input"), void 0 !== (e && e.detail ? e.detail[0] : arguments[1])), (e.detail && void 0 !== e.detail[1] || void 0 !== arguments[2]) && c.caret.call(t, i, e.detail ? e.detail[1] : arguments[2]);
                    },
            ...
            219: function(e, t, n) {
                ...
                function O(e, t, n, i) {
                    var r, o, l = "", s = 0, c = !1, u = {};
                    for(P(n).lastIndex = 0; r = P(n).exec(e);)if ("\\" === r[0]) c = !0;
                    else {
                        if (void 0 === t) {
                            if (!c && (o = w(r))) l += "(" + o[0] + ")", n.placeholder && "" !== n.placeholder ? (u[s] = n.placeholder[r.index % n.placeholder.length], u["".concat(r.index, "'").concat(n.placeholder[r.index % n.placeholder.length])] = r[0].charAt(0)) : u[s] = r[0].charAt(0);
                            else switch(r[0]){
                                case "[":
                                    l += "(";
                                    break;
                ...
                r.default.extendAliases({
                    datetime: {
                        mask: function(e) {
                            if (e.numericInput = !1, y.S = m.ordinalSuffix.join("|"), e.inputFormat = k[e.inputFormat] || e.inputFormat, e.repeat && (e.repeat = parseInt(e.repeat.toString()), e.repeat > 0)) {
                                for(var t = "", n = 0; n < e.repeat; n++)t += e.inputFormat;
                                e.inputFormat = t, e.repeat = 0;
                            }
                            return e.displayFormat = k[e.displayFormat] || e.displayFormat || e.inputFormat, e.outputFormat = k[e.outputFormat] || e.outputFormat || e.inputFormat, e.regex = O(e.inputFormat, void 0, e), e.min = M(e.min, e.inputFormat, e), e.max = M(e.max, e.inputFormat, e), null;
                        },
                        placeholder: "",
                        ...
                        postValidation: function(e, t, n, i, a, r, o, l) {
                            ...
                            if (i.fuzzy && (e = i.buffer, t = i.pos), (c = j.call(f, t, a, r)).targetMatch && c.targetMatch[0] && void 0 !== y[c.targetMatch[0]]) {
                                ...
                                if (!1 === new RegExp(u).test(d.join("")) && 2 === c.targetMatch[0].length && r.validPositions[c.targetMatchIndex] && r.validPositions[c.targetMatchIndex + 1] && (r.validPositions[c.targetMatchIndex + 1].input = "0"), "year" == p[2]) for(var h = s.getMaskTemplate.call(f, !1, 1, void 0, !0), m = t + 1; m < e.length; m++)e[m] = h[m], r.validPositions.splice(t + 1, 1);
                            }
                        ...
                        onKeyDown: function(e, t, n, i) {
                            e.ctrlKey && e.key === o.keys.ArrowRight && (this.inputmask._valueSet(E(new Date, i)), d(this).trigger("setvalue"));
                        },
            ...
            207: function(e, t, n) {
                ...
                function f(e, t) {
                    var n = 0;
                    for(var i in "+" === e && (n = l.seekNext.call(this, t.validPositions.length - 1)), t.tests)if ((i = parseInt(i)) >= n) {
                ...
                r.default.extendAliases({
                    numeric: {
                        ...
                        onBeforeMask: function(e, t) {
                            ...
                            e = l + ("" !== s ? i + s : s);
                            var f = 0;
                            if ("" !== i && (f = t.digitsOptional ? t.digits < s.length ? t.digits : s.length : t.digits, "" !== s || !t.digitsOptional)) {
                                var p = Math.pow(10, f || 1);
                                e = e.replace((0, a.escapeRegex)(i), "."), isNaN(parseFloat(e)) || (e = (t.roundingFN(parseFloat(e) * p) / p).toFixed(f)), e = e.toString().replace(".", i);
                            }
                        ...
                        onBeforeWrite: function(e, t, n, i) {
                            ...
                            if (e) switch(e.type){
                                ...
                                case "checkval":
                                    ...
                                    } else if ("" !== i.radixPoint) t.indexOf(i.radixPoint) === i.suffix.length && (o && o.buffer ? o.buffer.splice(0, 1 + i.suffix.length) : (t.splice(0, 1 + i.suffix.length), o = {
                                        refreshFromBuffer: !0,
                                        buffer: r(t)
                                    }));
                        ...
                        onKeyDown: function(e, t, n, i) {
                            ...
                            if (!e.shiftKey && (e.key === o.keys.Delete || e.key === o.keys.Backspace || e.key === o.keys.BACKSPACE_SAFARI) && n.begin !== t.length) {
                                if (t[e.key === o.keys.Delete ? n.begin - 1 : n.end] === i.negationSymbol.front) return a = t.slice().reverse(), "" !== i.negationSymbol.front && a.shift(), "" !== i.negationSymbol.back && a.pop(), r.trigger("setvalue", [
                                    a.join(""),
                                    n.begin
                                ]), !1;
                                if (!0 === i._radixDance) {
                                    ...
                                    if (i.digitsOptional) {
                                        if (0 === p) return (a = t.slice().reverse()).pop(), r.trigger("setvalue", [
                                            a.join(""),
                                            n.begin >= a.length ? a.length : n.begin
                                        ]), !1;
                                    } else if (-1 !== p && (n.begin < p || n.end < p || e.key === o.keys.Delete && (n.begin === p || n.begin - 1 === p))) return n.begin === n.end && (e.key === o.keys.Backspace || e.key === o.keys.BACKSPACE_SAFARI ? n.begin++ : e.key === o.keys.Delete && n.begin - 1 === p && (f = s.extend({}, n), n.begin--, n.end--)), (a = t.slice().reverse()).splice(a.length - n.begin, n.begin - n.end + 1), a = u(a, i.digits, i).join(""), f && (n = f), r.trigger("setvalue", [
                                        a,
                                ...
                                if (r.isAlternator) return function() {
                                    ...
                                    if (-1 === _ || "string" == typeof _) {
                                        ...
                                        for(var R = 0; R < T.length; R++){
                                            ...
                                            else if (0 === R && (k = i(v)), B && B.matches && B.matches.length > v.matches[0].matches.length) break;
                                            a = m.slice(), h = E, m = [];
            ...
            7215: function(e, t, n) {
                ...
                function l(e, t, n, i, a, s) {
                    ...
                    else for(; j >= 0; j--)if ((m = 0 === j ? o.getTest.call(c, 0) : d.validPositions[j]) && void 0 !== m.alternation) {
                    ...
                    if (void 0 !== v) {
                        ...
                        var T = [], A = -1;
                        for(y = b; b < r.getLastValidPosition.call(c, void 0, !0) + 1; y++)-1 === A && e <= y && void 0 !== t && (T.push(t), A = T.length - 1), (k = d.validPositions[b]) && !0 !== k.generatedInput && (0 !== b || k.input !== p.skipOptionalPartCharacter) && (void 0 === s || y < P || y >= S) && T.push(k.input), d.validPositions.splice(b, 1);
                ...
                function f(e, t, n, i, a, p, m) {
                    ...
                    if ("function" == typeof k.preValidation && !0 !== i && !0 !== p && (S = w(S = k.preValidation.call(g, r.getBuffer.call(g), x, t, u.call(g, e), k, b, e, n || a))), !0 === S) {
                        ...
                        if (g.hasAlternator && !0 !== a && !n && (a = !0, !1 === S && k.keepStatic && (c.call(g, r.getBuffer.call(g)) || 0 === x) ? S = l.call(g, x, t, n, i, void 0, e) : (u.call(g, e) && b.tests[x] && b.tests[x].length > 1 && k.keepStatic || !0 === S && !0 !== k.numericInput && b.tests[x] && b.tests[x].length > 1 && r.getLastValidPosition.call(g, void 0, !0) > x) && (S = l.call(g, !0))), !0 === S && (S = {
                            pos: x
...
//# sourceMappingURL=index.0b5c1320.js.map
